...
function default_1(router) {
    ...
    router.get("/v2/api/notes", authenticator_middleware_1.verifyToken, getNotes);
    router.post("/v2/api/notes", authenticator_middleware_1.verifyToken, (0, validators_middleware_1.RequestValidator)(note_schema_1.default), createNote);
    ...
    router.put("/v2/api/notes/:id", authenticator_middleware_1.verifyToken, (0, validators_middleware_1.RequestValidator)(note_schema_1.default), updateNoteById);
    router.get("/v2/api/notes/categories/:categoryId", authenticator_middleware_1.verifyToken, getAllNotesByCategory);
}
